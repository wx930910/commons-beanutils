...
public class PropsFirstPropertyUtilsBean {
	...
	public static PropertyUtilsBean mockPropertyUtilsBean1()
			throws InvocationTargetException, IllegalArgumentException, NoSuchMethodException, IllegalAccessException {
		...
		}).when(mockInstance).getPropertyOfMapBean(any(Map.class), any(String.class));
		doAnswer((stubInvo) -> {
			...
			return null;
		}).when(mockInstance).setPropertyOfMapBean(any(Map.class), any(String.class), any(Object.class));
		return mockInstance;
	}
}
